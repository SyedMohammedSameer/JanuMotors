...
export const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-1.458a9.337 9.337 0 004.121-4.121m-10.875 5.572c.621-1.039 1.25-2.092 1.875-3.155m-1.875 3.155l-1.875-3.155m1.875 3.155L12 15.128M12 15.128l-1.875 3.155m1.875-3.155l1.875-3.155M8.625 19.128a9.38 9.38 0 012.625.372A9.337 9.337 0 0115.375 21a9.337 9.337 0 01-4.121-1.458A9.337 9.337 0 012.625 15.375a9.337 9.337 0 011.458-4.121m9.375 10.875c.621-1.039 1.25-2.092 1.875-3.155m-1.875 3.155l-1.875-3.155m1.875 3.155L12 15.128m-1.875 3.155l1.875 3.155m-1.875-3.155L8.625 15.128M8.625 15.128a9.337 9.337 0 01-1.458 4.121" />
  </svg>
);
...
export const DocumentMagnifyingGlassIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m_9_1.5_h7.5_m-15_6_v5.625c0 .621.504 1.125 1.125 1.125h9.75a1.125 1.125 0 001.125-1.125V14.25m-5.625 4.5v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5a3.375 3.375 0 00-3.375-3.375H3.75" />
    </svg>
);

export const TruckIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.13 1.13 0 00-.987 1.106v.958m12.026 0H4.474" />
    </svg>
);

export const ChatBubbleLeftRightIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.265c-.305.022-.61.033-.918.033h-.788c-.308 0-.613-.011-.918-.033l-3.722-.265A2.122 2.122 0 013.75 14.894V10.608c0-.97.616-1.813 1.5-2.097m15 0c0-1.136-.847-2.1-1.98-2.193l-3.722-.265c-.305-.022-.61-.033-.918-.033h-.788c-.308 0-.613.011-.918-.033l-3.722.265A2.122 2.122 0 003.75 6.106V4.894c0-1.136.847-2.1 1.98-2.193l3.722-.265c.305-.022.61-.033.918-.033h.788c.308 0 .613.011.918-.033l3.722.265A2.122 2.122 0 0120.25 4.894v1.212" />
    </svg>
);
